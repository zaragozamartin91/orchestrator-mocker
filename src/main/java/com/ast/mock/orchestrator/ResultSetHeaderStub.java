...
public class ResultSetHeaderStub implements IResultSetHeader {
    ...
    public static ResultSetHeaderStub buildFull(Object... columns) {
        if (columns.length == 0) throw new IllegalArgumentException("Cantidad de argumentos invalida");
        if (columns.length % 3 != 0) throw new IllegalArgumentException("Cantidad de argumentos invalida");
