...
public class OrchestratorStub extends Orchestrator {
	...
	@Override
	public IProcedureResponse executeJavaOrchestration(IProcedureRequest anOriginalRequest, Map<String, Object> dataBag) {
		return orch.executeJavaOrchestration(anOriginalRequest, dataBag);
	}
